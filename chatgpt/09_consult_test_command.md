...
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "docs\development\01_shared_ts_scss_goal_and_roadmap.md","docs\development\02_shared_ts_scss_folder_structure_guide.md","docs\development\04_spine_games_android_environment_plan.md"
...
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode diff -RepoRoot "C:\xampp\htdocs" -UnstagedOnly
...
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode repo -RepoRoot "C:\xampp\htdocs" -AllowDocSetFolders

### repo（診断出力）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode repo -RepoRoot "C:\xampp\htdocs" -Diag
...
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common","pavilion-ellese","db\schema"

### include：ファイル1つ（相対パス）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common\src\App\Views\pavilion-ellese\partials\system\loader.php"

### include：ファイル複数（相対パス）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common\src\App\Views\pavilion-ellese\partials\system\loader.php","pavilion-ellese\Resources\i18n\Navigation.php"

### include：フォルダ＋ファイルを混在（従来互換）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common","pavilion-ellese\Resources\i18n\Navigation.php"

### include：絶対パス指定（ファイル/フォルダ混在も可）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths `
  "C:\xampp\htdocs\common",
  "C:\xampp\htdocs\pavilion-ellese\Resources\i18n\Navigation.php"

### include：カンマ区切り1文字列（スクリプト側が吸収する想定）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common,db\schema,pavilion-ellese"

### include：ファイル名のみ（v1.4.3：同名が1件なら成功）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "Navigation.php"

### include：ファイル名のみ複数（それぞれ1件に解決できる前提）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "Loader.php","Navigation.php"

### include：見つからない（WARNINGでスキップ→最終的に0件ならエラー停止）

pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "___THIS_FILE_DOES_NOT_EXIST___.php"

### include：ワイルドカード（v1.4.3は非対応→停止）

```powershell
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "*Nav*.php"
```
...
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode diff -RepoRoot "C:\xampp\htdocs" -Diag
...
cd C:\xampp\htdocs
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode diff -RepoRoot "C:\xampp\htdocs"
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode include -RepoRoot "C:\xampp\htdocs" -IncludePaths "common","pavilion-ellese"
pwsh -File tools\chatgpt\make_consult_bundle.ps1 -Mode repo -RepoRoot "C:\xampp\htdocs"
